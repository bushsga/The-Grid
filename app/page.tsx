    ...
    <main className="w-full">
      ...
      <section className="py-20 bg-gray-50">
        <Container>
          ...
          {/* ✅ NEW: "Shop Products" Button */}
          <div className="text-center mt-12">
            <Link href="/categories">
              <button className="bg-[#C8A75B] text-black px-8 py-3 text-sm font-medium hover:bg-[#b8964a] transition">
                Shop All Products
              </button>
            </Link>
          </div>
      ...
      <section className="py-20 bg-[#0B0F19] text-white text-center">
        <Container>
          ...
          <p className="mt-4 text-gray-300 text-sm sm:text-base">
            Use our smart watt calculator to estimate the right solar capacity for your home or business.
          </p>
