...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/icon.png', type: 'image/png' }, // Will be generated by app/icon.tsx
      { url: '/favicon.ico', sizes: 'any' }, // Will be generated
    ],
    apple: [
      { url: '/apple-icon.png', type: 'image/png' }, // Will be generated by app/apple-icon.tsx
    ],
  },
}
